...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (svg) {
        ...
        // Add hover and mousemove events for tooltip functionality
        statePaths.forEach((state) => {
            ...
            state.addEventListener("click", () => {
                ...
                if (stateName) {
                    ...
                    console.error("State does not have a 'data-info' attribute.");
                }
            });
        });
    } else {
...
// Hover and Tooltip Interaction for Info Box (from map-main.js)
